...
if(!IS_DEV){
  ...
  const data  = {
    ...
    authToken : "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2ZDg1MjhmYTI3YmY5MDI0NDNlYmExZiIsInVzZXJuYW1lIjoiYXJwaXQiLCJyb2xlIjoicGxheWVyIiwiaWF0IjoxNzM3OTY5MTIzLCJleHAiOjE3Mzg1NzM5MjN9.qEK45T5eJOQfCDWefe-cH7taONlGuxWpx-Il61BMJMQ",
  }
  Globals.Socket = new SocketManager();
  Globals.Socket.onToken(data);
}
